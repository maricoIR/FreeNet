        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-coffee-600 dark:text-sand-200/80 leading-7">
              این پروژه با هدف کمک به کاربران ایرانی ساخته شده است تا دسترسی به اینترنت آزاد را
              آسان‌تر کند. تمام روش‌ها، آموزش‌ها و ابزارهای معرفی‌شده در یک‌جا گردآوری شده‌اند تا
              دیگر نیازی به جست‌وجوی پراکنده نباشد.
            </p>
            ...
            <p className="text-sm text-coffee-600 dark:text-sand-200/80 leading-7">
              فراهم سازی این پروژه بدون زحمات افرادی که این ابزارها را ساخته‌اند و آموزش‌ها را تهیه
              کرده‌اند ممکن نبود. از آن‌ها قدردانی و حمایت کنید.
            </p>
